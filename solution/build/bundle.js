...
/***/ function(module, exports, __webpack_require__) {
	...
	var _movies = __webpack_require__(293);
	
	var _movies2 = _interopRequireDefault(_movies);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var a = new _movies.Actor("Tom", "Hanks", "Forrest Gump", "Captain Miller", "Paul Edgecomb");
	console.log('Actor: ' + a);
	
	var m = new _movies2.default("Forrest Gump", "drama", 135, new _movies.Actor("Tom", "Hanks", "Forrest", "Gump"));
	m.addActor(new _movies.Actor("Robin", "Wright", "Jenny Curran"));
	console.log('Movie: ' + m);
	
	var n = new _movies2.default("Fight Club");
	n.addActor(new _movies.Actor("Edward", "Norton", "The Narrator"));
	n.addActor(new _movies.Actor("Brad", "Pitt", "Tyler Durden"));
	console.log('Movie ' + n + ' staring ' + n.characters.join(', '));
	
	console.log(_movies.demo.toString());
	
	var starWars = new _movies2.default("Star Wars Episode IV: A New Hope", "fantasy", 124);
	starWars.addActor(new _movies.Actor("Alec", "Guiness", "Obi Wan Kenobi"));
	starWars.addActor(new _movies.Actor("Mark", "Hamill", "Luke Skywalker"));
	starWars.addActor(new _movies.Actor("Carrie", "Fisher", "Princes Leia"));
	starWars.addActor(new _movies.Actor("Anthony", "Daniels", "C3PO"));
	starWars.addActor(new _movies.Actor("David", "Prowse", "Darth Vader"));
	var _iteratorNormalCompletion = true;
	var _didIteratorError = false;
	var _iteratorError = undefined;
	
	try {
	    for (var _iterator = starWars[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Movie = function () {
	    function Movie(title) {
	        var genre = arguments.length <= 1 || arguments[1] === undefined ? 'drama' : arguments[1];
	        var runtime = arguments.length <= 2 || arguments[2] === undefined ? 120 : arguments[2];
	        ...
	        for (var _len = arguments.length, actors = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
	            actors[_key - 3] = arguments[_key];
	        }
	                ...
	                while (1) {
	                    switch (_context.prev = _context.next) {
	                        case 0:
	                            ...
	                            _context.prev = 3;
	                            _iterator = this.actors[Symbol.iterator]();
	...
	var demo = exports.demo = new Movie("The Good, the Bad and the Ugly", "");
	demo.addActor(new _actors.Actor("Eli", "Wallach", "Tuco"));
	demo.addActor(new _actors.Actor("Clint", "Eastwood", "Blondie"));
	demo.addActor(new _actors.Actor("Lee", "Van Cleef", "Sentenza"));
...
/***/ function(module, exports) {
	...
	var Actor = exports.Actor = function (_Person) {
	    _inherits(Actor, _Person);
	
	    function Actor(firstName, lastName) {
	        _classCallCheck(this, Actor);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Actor).call(this, firstName, lastName));
