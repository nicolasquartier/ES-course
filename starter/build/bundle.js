...
/***/ function(module, exports, __webpack_require__) {
	...
	var _realdolmen = __webpack_require__(300);
	
	var rd = _interopRequireWildcard(_realdolmen);
	
	var _Actor = __webpack_require__(302);
	
	var _Actor2 = _interopRequireDefault(_Actor);
	
	var _Movie = __webpack_require__(303);
	...
	var a = new _Actor2.default("Tom", "Hanks", "Forrest Gump", "Captain Miller", "Paul EdgeComb");
	console.log('Actor: ' + a.toString());
	
	var m = new _Movie2.default("Forrest Gump", "drama", 135, new _Actor2.default("Tom", "Hanks", "Forrest", "Gump"));
	m.addActor(new _Actor2.default("Robin", "Wright", "Jenny Curran"));
	console.log('Movie: ' + m);
	
	var n = new _Movie2.default("Fight Club");
	n.addActor(new _Actor2.default("Edward", "Norton", "The Narrator"));
	n.addActor(new _Actor2.default("Brad", "Pitt", "Tyle Durden"));
